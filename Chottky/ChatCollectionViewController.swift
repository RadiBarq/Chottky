...
class ChatCollectionViewController: UICollectionViewController, UICollectionViewDelegateFlowLayout {
    ...
    let userPhotoUrlRef = FIRDatabase.database().reference().child("Users").child(MessagesTableViewController.messageTo_Email).child("photoUrl")
    ...
    lazy var inputContainterView: UIView =
        {
            ...
            sendButton.setTitleColor(UIColor.cyan, for: .normal)
            ...
            self.inputTextField.textColor = UIColor.cyan
    ...
    override func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        if messagesFrom[indexPath.row] == WelcomeViewController.user.getUserDisplayName()
        {
            ...
            cell.bubbleView.backgroundColor = UIColor.cyan
